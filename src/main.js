...
const createWindow = () => {
  ...
  menu.items[0].submenu.append(new MenuItem({
    // menu.items获取的是主菜单一级菜单的菜单数组, menu.items[0]在这里就是第一个File菜单对象, 在其子菜单submenu中添加新的子菜单
    label: 'New',
    click() {
  ...
  Menu.setApplicationMenu(menu); // 注意：这个代码要放到菜单添加完成之后, 否则会造成新菜单的快捷键无效
